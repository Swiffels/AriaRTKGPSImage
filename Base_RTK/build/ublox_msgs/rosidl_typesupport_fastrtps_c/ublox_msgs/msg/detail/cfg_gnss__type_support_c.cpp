...
bool cdr_serialize_ublox_msgs__msg__CfgGNSSBlock(
  const ublox_msgs__msg__CfgGNSSBlock * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_ublox_msgs__msg__CfgGNSSBlock(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs__msg__CfgGNSSBlock * ros_message);
...
bool cdr_serialize_key_ublox_msgs__msg__CfgGNSSBlock(
  const ublox_msgs__msg__CfgGNSSBlock * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_ublox_msgs__msg__CfgGNSSBlock(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_ublox_msgs__msg__CfgGNSSBlock(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_ublox_msgs__msg__CfgGNSS(
  const ublox_msgs__msg__CfgGNSS * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: msg_ver
  {
  ...
  // Field name: blocks
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ublox_msgs__msg__CfgGNSSBlock(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_deserialize_ublox_msgs__msg__CfgGNSS(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs__msg__CfgGNSS * ros_message)
{
  // Field name: msg_ver
  {
    cdr >> ros_message->msg_ver;
  ...
  // Field name: blocks
  {
    ...
    auto array_ptr = ros_message->blocks.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ublox_msgs__msg__CfgGNSSBlock(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_serialize_key_ublox_msgs__msg__CfgGNSS(
  const ublox_msgs__msg__CfgGNSS * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: msg_ver
  ...
  // Field name: blocks
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ublox_msgs__msg__CfgGNSSBlock(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t get_serialized_size_key_ublox_msgs__msg__CfgGNSS(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CfgGNSS__ros_msg_type * ros_message = static_cast<const _CfgGNSS__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: blocks
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ublox_msgs__msg__CfgGNSSBlock(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t max_serialized_size_key_ublox_msgs__msg__CfgGNSS(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: blocks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ublox_msgs__msg__CfgGNSSBlock(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ublox_msgs__msg__CfgGNSS * ros_message = static_cast<const ublox_msgs__msg__CfgGNSS *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ublox_msgs__msg__CfgGNSS(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ublox_msgs__msg__CfgGNSS * ros_message = static_cast<ublox_msgs__msg__CfgGNSS *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ublox_msgs__msg__CfgGNSS(cdr, ros_message);
}
