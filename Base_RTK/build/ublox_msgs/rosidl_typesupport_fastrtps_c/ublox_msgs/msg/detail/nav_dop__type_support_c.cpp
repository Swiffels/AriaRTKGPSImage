...
bool cdr_serialize_ublox_msgs__msg__NavDOP(
  const ublox_msgs__msg__NavDOP * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_deserialize_ublox_msgs__msg__NavDOP(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs__msg__NavDOP * ros_message)
{
  // Field name: i_tow
  {
    cdr >> ros_message->i_tow;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_serialize_key_ublox_msgs__msg__NavDOP(
  const ublox_msgs__msg__NavDOP * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: i_tow
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t get_serialized_size_key_ublox_msgs__msg__NavDOP(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavDOP__ros_msg_type * ros_message = static_cast<const _NavDOP__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t max_serialized_size_key_ublox_msgs__msg__NavDOP(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ublox_msgs__msg__NavDOP * ros_message = static_cast<const ublox_msgs__msg__NavDOP *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ublox_msgs__msg__NavDOP(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ublox_msgs__msg__NavDOP * ros_message = static_cast<ublox_msgs__msg__NavDOP *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ublox_msgs__msg__NavDOP(cdr, ros_message);
}
