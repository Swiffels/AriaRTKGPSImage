...
bool cdr_serialize_ublox_msgs__msg__EsfRAWBlock(
  const ublox_msgs__msg__EsfRAWBlock * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_ublox_msgs__msg__EsfRAWBlock(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs__msg__EsfRAWBlock * ros_message);
...
bool cdr_serialize_key_ublox_msgs__msg__EsfRAWBlock(
  const ublox_msgs__msg__EsfRAWBlock * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_ublox_msgs__msg__EsfRAWBlock(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_ublox_msgs__msg__EsfRAWBlock(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_ublox_msgs__msg__EsfRAW(
  const ublox_msgs__msg__EsfRAW * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: blocks
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ublox_msgs__msg__EsfRAWBlock(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_deserialize_ublox_msgs__msg__EsfRAW(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs__msg__EsfRAW * ros_message)
{
  // Field name: reserved0
  {
    size_t size = 4;
  ...
  // Field name: blocks
  {
    ...
    auto array_ptr = ros_message->blocks.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ublox_msgs__msg__EsfRAWBlock(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_serialize_key_ublox_msgs__msg__EsfRAW(
  const ublox_msgs__msg__EsfRAW * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: reserved0
  ...
  // Field name: blocks
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ublox_msgs__msg__EsfRAWBlock(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t get_serialized_size_key_ublox_msgs__msg__EsfRAW(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EsfRAW__ros_msg_type * ros_message = static_cast<const _EsfRAW__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: blocks
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ublox_msgs__msg__EsfRAWBlock(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t max_serialized_size_key_ublox_msgs__msg__EsfRAW(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: blocks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ublox_msgs__msg__EsfRAWBlock(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ublox_msgs__msg__EsfRAW * ros_message = static_cast<const ublox_msgs__msg__EsfRAW *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ublox_msgs__msg__EsfRAW(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ublox_msgs__msg__EsfRAW * ros_message = static_cast<ublox_msgs__msg__EsfRAW *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ublox_msgs__msg__EsfRAW(cdr, ros_message);
}
