...
bool cdr_serialize_ublox_msgs__msg__MonHW(
  const ublox_msgs__msg__MonHW * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_deserialize_ublox_msgs__msg__MonHW(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs__msg__MonHW * ros_message)
{
  // Field name: pin_sel
  {
    cdr >> ros_message->pin_sel;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_serialize_key_ublox_msgs__msg__MonHW(
  const ublox_msgs__msg__MonHW * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: pin_sel
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t get_serialized_size_key_ublox_msgs__msg__MonHW(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MonHW__ros_msg_type * ros_message = static_cast<const _MonHW__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t max_serialized_size_key_ublox_msgs__msg__MonHW(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ublox_msgs__msg__MonHW * ros_message = static_cast<const ublox_msgs__msg__MonHW *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ublox_msgs__msg__MonHW(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ublox_msgs__msg__MonHW * ros_message = static_cast<ublox_msgs__msg__MonHW *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ublox_msgs__msg__MonHW(cdr, ros_message);
}
