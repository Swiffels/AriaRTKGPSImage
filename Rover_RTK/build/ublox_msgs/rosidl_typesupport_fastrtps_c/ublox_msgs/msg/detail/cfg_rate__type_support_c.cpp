...
bool cdr_serialize_ublox_msgs__msg__CfgRATE(
  const ublox_msgs__msg__CfgRATE * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_deserialize_ublox_msgs__msg__CfgRATE(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs__msg__CfgRATE * ros_message)
{
  // Field name: meas_rate
  {
    cdr >> ros_message->meas_rate;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_serialize_key_ublox_msgs__msg__CfgRATE(
  const ublox_msgs__msg__CfgRATE * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: meas_rate
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t get_serialized_size_key_ublox_msgs__msg__CfgRATE(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CfgRATE__ros_msg_type * ros_message = static_cast<const _CfgRATE__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t max_serialized_size_key_ublox_msgs__msg__CfgRATE(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ublox_msgs__msg__CfgRATE * ros_message = static_cast<const ublox_msgs__msg__CfgRATE *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ublox_msgs__msg__CfgRATE(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ublox_msgs__msg__CfgRATE * ros_message = static_cast<ublox_msgs__msg__CfgRATE *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ublox_msgs__msg__CfgRATE(cdr, ros_message);
}
