...
bool cdr_serialize_ublox_msgs__msg__NavSBASSV(
  const ublox_msgs__msg__NavSBASSV * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_ublox_msgs__msg__NavSBASSV(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs__msg__NavSBASSV * ros_message);
...
bool cdr_serialize_key_ublox_msgs__msg__NavSBASSV(
  const ublox_msgs__msg__NavSBASSV * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_ublox_msgs__msg__NavSBASSV(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_ublox_msgs__msg__NavSBASSV(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_ublox_msgs__msg__NavSBAS(
  const ublox_msgs__msg__NavSBAS * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: i_tow
  {
  ...
  // Field name: sv
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ublox_msgs__msg__NavSBASSV(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_deserialize_ublox_msgs__msg__NavSBAS(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs__msg__NavSBAS * ros_message)
{
  // Field name: i_tow
  {
    cdr >> ros_message->i_tow;
  ...
  // Field name: sv
  {
    ...
    auto array_ptr = ros_message->sv.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ublox_msgs__msg__NavSBASSV(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_serialize_key_ublox_msgs__msg__NavSBAS(
  const ublox_msgs__msg__NavSBAS * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: i_tow
  ...
  // Field name: sv
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ublox_msgs__msg__NavSBASSV(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t get_serialized_size_key_ublox_msgs__msg__NavSBAS(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavSBAS__ros_msg_type * ros_message = static_cast<const _NavSBAS__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: sv
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ublox_msgs__msg__NavSBASSV(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t max_serialized_size_key_ublox_msgs__msg__NavSBAS(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: sv
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ublox_msgs__msg__NavSBASSV(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ublox_msgs__msg__NavSBAS * ros_message = static_cast<const ublox_msgs__msg__NavSBAS *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ublox_msgs__msg__NavSBAS(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ublox_msgs__msg__NavSBAS * ros_message = static_cast<ublox_msgs__msg__NavSBAS *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ublox_msgs__msg__NavSBAS(cdr, ros_message);
}
