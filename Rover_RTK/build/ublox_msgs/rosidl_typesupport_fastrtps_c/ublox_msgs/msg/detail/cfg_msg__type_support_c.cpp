  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ublox_msgs__msg__CfgMSG * ros_message = static_cast<const ublox_msgs__msg__CfgMSG *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ublox_msgs__msg__CfgMSG(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ublox_msgs__msg__CfgMSG * ros_message = static_cast<ublox_msgs__msg__CfgMSG *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ublox_msgs__msg__CfgMSG(cdr, ros_message);
}
