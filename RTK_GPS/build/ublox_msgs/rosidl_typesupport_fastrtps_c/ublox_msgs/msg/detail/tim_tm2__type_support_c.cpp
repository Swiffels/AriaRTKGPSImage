...
bool cdr_serialize_ublox_msgs__msg__TimTM2(
  const ublox_msgs__msg__TimTM2 * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_deserialize_ublox_msgs__msg__TimTM2(
  eprosima::fastcdr::Cdr & cdr,
  ublox_msgs__msg__TimTM2 * ros_message)
{
  // Field name: ch
  {
    cdr >> ros_message->ch;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
bool cdr_serialize_key_ublox_msgs__msg__TimTM2(
  const ublox_msgs__msg__TimTM2 * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: ch
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t get_serialized_size_key_ublox_msgs__msg__TimTM2(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TimTM2__ros_msg_type * ros_message = static_cast<const _TimTM2__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ublox_msgs
size_t max_serialized_size_key_ublox_msgs__msg__TimTM2(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ublox_msgs__msg__TimTM2 * ros_message = static_cast<const ublox_msgs__msg__TimTM2 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ublox_msgs__msg__TimTM2(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ublox_msgs__msg__TimTM2 * ros_message = static_cast<ublox_msgs__msg__TimTM2 *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ublox_msgs__msg__TimTM2(cdr, ros_message);
}
